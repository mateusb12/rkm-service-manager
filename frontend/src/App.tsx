...
const TextInput = ({ value, onChange, placeholder, type = 'text', disabled = false }) => (React.createElement("input", { className: "rkm-input zenit-field", type: type, value: value || '', placeholder: placeholder || '', disabled, onChange: e => onChange(e.target.value) }));
 ...
 */
const SHOW_DEV_GUIDES = import.meta.env.DEV;
...
const getBenchStep = (service) => {
    const config = IT_CONFIG[service.it];
